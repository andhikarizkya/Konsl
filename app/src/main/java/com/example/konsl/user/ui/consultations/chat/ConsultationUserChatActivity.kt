package com.example.konsl.user.ui.consultations.chat
...
class ConsultationUserChatActivity : AppCompatActivity() {
    companion object{
        const val EXTRA_CONSULTATION = "extra_consultation"
    }
    private lateinit var viewModel: ConsultationUserChatViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_consultation_user_chat)
        ...
        viewModel = ViewModelProvider(this).get(ConsultationUserChatViewModel::class.java)
        ...
        supportActionBar?.let {
            it.title = consultation?.counselorName
